...
public interface HermesTranslator {
    ...
    /**
     * Translates from ShExCSV format to ShExC format. the input files are the prefixes CSV file and the shapes CSV
     * file, both following the formats defined at <a href="https://github.com/weso/hermes">GitHub repo README</a>. If
     * the input files do not follow this specification the method will raise an exception indicating the element of the
     ...
     *
     * @return an formatted string containing the ShExC representation of the input Shape Expressions if there is no
     * error during the translation. Otherwise an empty string.
     *
